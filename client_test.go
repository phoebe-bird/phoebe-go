...
func TestRetryAfter(t *testing.T) {
	...
	res, err := client.Ref.Hotspot.Info.Get(context.Background(), "L99381")
	if err == nil || res != nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	res, err := client.Ref.Hotspot.Info.Get(cancelCtx, "L99381")
	if err == nil || res != nil {
		t.Error("Expected there to be a cancel error and for the response to be nil")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		res, err := client.Ref.Hotspot.Info.Get(deadlineCtx, "L99381")
		if err == nil || res != nil {
