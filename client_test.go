...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Ref.Hotspot.Info.Get(context.Background(), "L99381")
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Ref.Hotspot.Info.Get(cancelCtx, "L99381")
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Ref.Hotspot.Info.Get(deadlineCtx, "L99381")
		if err == nil {
