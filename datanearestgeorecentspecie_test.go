...
func TestDataNearestGeoRecentSpecieListWithOptionalParams(t *testing.T) {
	...
	err := client.Data.Nearest.Geo.Recent.Species.List(
		context.TODO(),
		"string",
		phoebe.DataNearestGeoRecentSpecieListParams{
